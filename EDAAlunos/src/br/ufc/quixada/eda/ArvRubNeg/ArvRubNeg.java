package br.ufc.quixada.eda.ArvRubNeg;

public class ArvRubNeg<Chave extends Comparable<Chave>, Info> {
    ...
    public static void main(String[] args) {
    	ArvRubNeg<Integer, Integer> rn = new ArvRubNeg<Integer, Integer>();
    	rn.inserir(5, 5);
        rn.inserir(9, 9);
        rn.inserir(13, 13);
        rn.inserir(11, 11);
